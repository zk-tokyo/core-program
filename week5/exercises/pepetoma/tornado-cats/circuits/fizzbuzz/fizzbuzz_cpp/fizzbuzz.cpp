...
void FizzBuzz_7_create(uint soffset,uint coffset,Circom_CalcWit* ctx,std::string componentName,uint componentFather);
void FizzBuzz_7_run(uint ctx_index,Circom_CalcWit* ctx);
...
uint get_total_signal_no() {return 1051;}

uint get_number_of_components() {return 226;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 736;}
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_idiv(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[6]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 1];
// load src
Fr_mod(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[6]); // line circom 16
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
Fr_mul(&expaux[2],&circuitConstants[6],&signalValues[mySignalStart + 0]); // line circom 21
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 1]); // line circom 21
{{
Fr_eq(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 21
}}
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_idiv(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[7]); // line circom 15
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 1];
// load src
Fr_mod(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[7]); // line circom 16
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
Fr_mul(&expaux[2],&circuitConstants[7],&signalValues[mySignalStart + 0]); // line circom 21
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 1]); // line circom 21
{{
Fr_eq(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 21
}}
...
uint csoffset = mySignalStart+540;
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
...
uint csoffset = mySignalStart+780;
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
std::string new_cmp_name = "isMultipleOf15"+ctx->generate_position_array(aux_dimensions, 1, i);
IsEqual_6_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 6 ;
aux_cmp_num += 2;
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[7]); // line circom 51
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 45);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 45);
Fr_mul(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 45)]].signalStart + 0],&circuitConstants[8]); // line circom 91
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 45);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 45);
Fr_sub(&expaux[3],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 45)]].signalStart + 0]); // line circom 91
Fr_mul(&expaux[2],&expaux[3],&lvar[2]); // line circom 91
Fr_add(&expaux[0],&expaux[1],&expaux[2]); // line circom 91
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 60);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 60);
Fr_mul(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 60)]].signalStart + 0],&circuitConstants[9]); // line circom 92
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 60);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 60);
Fr_sub(&expaux[3],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 60)]].signalStart + 0]); // line circom 92
Fr_mul(&expaux[2],&expaux[3],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 30)]); // line circom 92
Fr_add(&expaux[0],&expaux[1],&expaux[2]); // line circom 92
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 75);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 75);
Fr_mul(&expaux[1],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 75)]].signalStart + 0],&circuitConstants[10]); // line circom 93
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 75);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[1])) + 75);
Fr_sub(&expaux[3],&circuitConstants[2],&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[1])) + 75)]].signalStart + 0]); // line circom 93
Fr_mul(&expaux[2],&expaux[3],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[1])) + 45)]); // line circom 93
Fr_add(&expaux[0],&expaux[1],&expaux[2]); // line circom 93
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
FizzBuzz_7_create(1,0,ctx,"main",0);
FizzBuzz_7_run(0,ctx);
}
