...
int cmp_index_ref_load = -1;
{
std::string new_cmp_name = "mult2_1";
Multiplier2_0_create(mySignalStart+5,0+ctx_index+1,ctx,new_cmp_name,myId);
mySubcomponents[0] = 0+ctx_index+1;
}
{
std::string new_cmp_name = "mult2_2";
Multiplier2_0_create(mySignalStart+8,1+ctx_index+1,ctx,new_cmp_name,myId);
