...
uint get_total_signal_no() {return 706;}
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_idiv(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[5]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mod(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[5]); // line circom 12
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
Fr_mul(&expaux[2],&circuitConstants[5],&signalValues[mySignalStart + 0]); // line circom 14
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 1]); // line circom 14
{{
Fr_eq(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 14
}}
...
cmp_index_ref_load = 0;
{{
Fr_eq(&expaux[0],&ctx->signalValues[ctx->componentMemory[mySubcomponents[0]].signalStart + 0],&circuitConstants[2]); // line circom 19
}}
...
PFrElement aux_dest = &signalValues[mySignalStart + 0];
// load src
Fr_idiv(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[6]); // line circom 11
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + 1];
// load src
Fr_mod(&expaux[0],&signalValues[mySignalStart + 2],&circuitConstants[6]); // line circom 12
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
Fr_mul(&expaux[2],&circuitConstants[6],&signalValues[mySignalStart + 0]); // line circom 14
Fr_add(&expaux[1],&expaux[2],&signalValues[mySignalStart + 1]); // line circom 14
{{
Fr_eq(&expaux[0],&expaux[1],&signalValues[mySignalStart + 2]); // line circom 14
}}
...
uint csoffset = mySignalStart+375;
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
...
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
std::string new_cmp_name = "isZero3"+ctx->generate_position_array(aux_dimensions, 1, i);
...
uint csoffset = mySignalStart+660;
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
std::string new_cmp_name = "isZero5"+ctx->generate_position_array(aux_dimensions, 1, i);
IsZero_4_create(csoffset,aux_cmp_num,ctx,new_cmp_name,myId);
mySubcomponents[aux_create+ i] = aux_cmp_num;
csoffset += 3 ;
aux_cmp_num += 1;
...
Fr_lt(&expaux[0],&lvar[0],&circuitConstants[7]); // line circom 39
while(Fr_isTrue(&expaux[0])){
{
printf("=== ");
}
...
{
char* temp = Fr_element2str(&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 15)]);
printf("%s",temp);
delete [] temp;
}
{
...
// load src
// end load src
Fr_copy(aux_dest,&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 15)]);
}
...
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[0])) + 15);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 2];
// load src
// end load src
...
{
uint cmp_index_ref = ((1 * Fr_toInt(&lvar[0])) + 30);
{
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
...
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[0])) + 0);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 0)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
...
PFrElement aux_dest = &ctx->signalValues[ctx->componentMemory[mySubcomponents[cmp_index_ref]].signalStart + 1];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[0])) + 15);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[0])) + 15);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 15)]].signalStart + 1]);
}
// run sub component if needed
if(!(ctx->componentMemory[mySubcomponents[cmp_index_ref]].inputCounter -= 1)){
IsZero_4_run(mySubcomponents[cmp_index_ref],ctx);
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 30)];
// load src
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[0])) + 30);
cmp_index_ref_load = ((1 * Fr_toInt(&lvar[0])) + 30);
// end load src
Fr_copy(aux_dest,&ctx->signalValues[ctx->componentMemory[mySubcomponents[((1 * Fr_toInt(&lvar[0])) + 30)]].signalStart + 0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 45)];
// load src
...
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 60)];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 30)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 45)]); // line circom 56
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 75)];
// load src
Fr_sub(&expaux[0],&circuitConstants[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 30)]); // line circom 58
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 90)];
// load src
Fr_sub(&expaux[0],&circuitConstants[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 45)]); // line circom 59
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 105)];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 30)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 90)]); // line circom 61
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
PFrElement aux_dest = &signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 120)];
// load src
Fr_mul(&expaux[0],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 45)],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 75)]); // line circom 62
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
// load src
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 60)],&circuitConstants[5]); // line circom 64
Fr_mul(&expaux[3],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 105)],&circuitConstants[2]); // line circom 64
Fr_add(&expaux[1],&expaux[2],&expaux[3]); // line circom 64
Fr_mul(&expaux[2],&signalValues[mySignalStart + ((1 * Fr_toInt(&lvar[0])) + 120)],&circuitConstants[8]); // line circom 64
Fr_add(&expaux[0],&expaux[1],&expaux[2]); // line circom 64
// end load src
Fr_copy(aux_dest,&expaux[0]);
}
{
...
Fr_mod(&expaux[1],&lvar[1],&circuitConstants[7]); // line circom 67
{{
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 67
}}
if(Fr_isTrue(&expaux[0])){
{
printf("FizzBuzz");
...
Fr_mod(&expaux[1],&lvar[1],&circuitConstants[5]); // line circom 69
{{
...
Fr_mod(&expaux[1],&lvar[1],&circuitConstants[6]); // line circom 71
{{
Fr_eq(&expaux[0],&expaux[1],&circuitConstants[1]); // line circom 71
}}
if(Fr_isTrue(&expaux[0])){
{
printf("Buzz");
