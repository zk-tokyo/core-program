...
uint get_total_signal_no() {return 1066;}

uint get_number_of_components() {return 271;}

uint get_size_of_input_hashmap() {return 256;}

uint get_size_of_witness() {return 511;}
...
uint csoffset = mySignalStart+570;
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
...
uint csoffset = mySignalStart+945;
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
...
uint csoffset = mySignalStart+825;
uint aux_dimensions[1] = {15};
for (uint i = 0; i < 15; i++) {
...
Fr_lt(&expaux[0],&lvar[1],&circuitConstants[6]); // line circom 53
while(Fr_isTrue(&expaux[0])){
{
PFrElement aux_dest = &lvar[2];
// load src
